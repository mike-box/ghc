...
rewriteEvidence old_ev@(CtDerived {}) (Reduction _old_pred _dco new_pred)
...
rewriteEvidence old_ev (Reduction _old_pred dco new_pred)
...
rewriteEqEvidence :: CtEvidence         -- Old evidence :: olhs ~ orhs (not swapped)
                  ...
                  -> SwapFlag
                  -> Reduction  -- olhs, lhs_co :: olhs ~ nlhs
                  -> Reduction  -- orhs, rhs_co :: orhs ~ nrhs
